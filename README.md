...
[![Build, test, and audit](https://github.com/MinecraftModDevelopmentMods/MinecraftMineralogy/actions/workflows/ci.yml/badge.svg?branch=master-1.15.2)](https://github.com/MinecraftModDevelopmentMods/MinecraftMineralogy/actions/workflows/ci.yml?query=branch%3Amaster-1.15.2)

# Mineralogy 6 for Minecraft 1.15.2
...
This branch builds Mineralogy `6.0.1.115021` for Forge `31.2.57` and is built
and tested against OreSpawn `4.0.9.115021`. Its declared compatibility range is
