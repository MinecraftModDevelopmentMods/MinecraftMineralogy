...
exact Forge `26.3-66.0.0` development dependency and is excluded from every
...
Forge `26.3-66.0.0` compiles without source compatibility edits. Its explicit
...
`ORESPAWN_MAVENIZER_OFFLINE=true`. Mavenizer, OreSpawn and Minecraft 26.3 all
