...
All Mineralogy recipes are native Minecraft/Forge 1.15.2 JSON under
...
tree. Polishing uses Minecraft 1.15.2's advancement requirements matrix to
...
Forge 31 converts pre-flattening chunks lazily. The legacy chunk-loader hook
...
Forge constructs them. Forge 31 parses a tile ID as a `ResourceLocation` before
...
[Mineralogy Versioning](VERSIONS.md). This branch validates target `115021`
for Minecraft 1.15.2 Forge and does not append CI build numbers.
