...
All Mineralogy recipes are native Minecraft/Forge 1.14.4 JSON under
...
tree. Polishing uses Minecraft 1.14.4's advancement requirements matrix to
...
Forge 28 converts pre-flattening chunks lazily. The legacy chunk-loader hook
...
Forge constructs them. Forge 28 parses a tile ID as a `ResourceLocation` before
...
[Mineralogy Versioning](VERSIONS.md). This branch validates target `114041`
for Minecraft 1.14.4 Forge and does not append CI build numbers.
