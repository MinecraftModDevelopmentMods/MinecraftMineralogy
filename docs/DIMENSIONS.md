...
The Overworld is Mineralogy's only default terrain-replacement dimension. The
Nether and End are untouched unless a global/world profile explicitly enables
them. Providers may automatically opt in only dimensions in their own
namespace.
...
Mineralogy resolves dimensions, hosts, tags, rocks, and biome filters before
