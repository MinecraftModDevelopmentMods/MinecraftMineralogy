...
```text
6.0.0.110021 -> 6.1.0.110021
6.1.4.110021 -> 7.0.0.110021
```
...
Minecraft 1.12.2 / Forge / Mineralogy 6.0.0.112021
...
target calculation, so the matching Minecraft 1.10.2 Forge release is
`4.0.6.110021`. The dependency range deliberately describes the supported
