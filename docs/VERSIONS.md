...
this Minecraft 1.14.4 Forge release is therefore:
...
`6.0.1.114041`, not `1.14.4-6.0.1.114041`. The Target already makes tags unique
...
The 1.14.4 row records this branch's current release. The other rows illustrate
...
```text
6.0.1.114041 -> 6.1.0.114041
6.1.4.114041 -> 7.0.0.114041
```
...
target calculation, so the matching Minecraft 1.14.4 Forge release is
`4.0.8.114041`. The dependency range deliberately describes the supported
...
branch, published metadata and artifacts therefore use `6.0.1.114041`.
