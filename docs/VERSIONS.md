...
target calculation, so the matching Minecraft 26.2 Forge release used for
this candidate is `4.0.16.2602001`. The dependency range deliberately describes the supported
