...
target calculation, so the matching Minecraft 26.3 Forge release used for
this candidate is `4.0.16.2603001`. The dependency range deliberately describes the supported
