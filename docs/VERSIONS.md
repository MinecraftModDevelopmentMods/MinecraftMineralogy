...
this Minecraft 1.16.5 Forge release is therefore:
...
`6.0.1.116051`, not `1.16.5-6.0.1.116051`. The Target already makes tags unique
...
| 1.16.5 | Forge | `116051` | `6.0.1.116051` |
...
The 1.16.5 row records this branch's current release. The other rows illustrate
...
```text
6.0.1.116051 -> 6.1.0.116051
6.1.4.116051 -> 7.0.0.116051
```
...
Minecraft 1.16.5 / Forge / Mineralogy 6.0.1.116051
...
target calculation, so the matching Minecraft 1.16.5 Forge release is
`4.0.9.116051`. The dependency range deliberately describes the supported
...
branch, published metadata and artifacts therefore use `6.0.1.116051`.
