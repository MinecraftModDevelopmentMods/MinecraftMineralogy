...
if ($Check) {
    if (-not (Test-Path -LiteralPath $definitionRoot)) {
        throw "Missing Minecraft 26.3 item-definition directory $definitionRoot"
    }
    ...
    Write-Output 'Verified 928 Minecraft 26.3 Mineralogy item definitions.'
    return
}
...
Write-Output 'Generated 928 Minecraft 26.3 Mineralogy item definitions.'
