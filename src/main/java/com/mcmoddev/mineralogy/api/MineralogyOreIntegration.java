...
/**
 * Compatibility facade for the original ore-provider API.
 *
 * @deprecated Use {@link MineralogyApi}. This class remains available so
...
public final class MineralogyOreIntegration {
	...
	public static ProviderStatus getProviderStatus(String providerModId) {
		return ProviderStatus.valueOf(MineralogyApi.getProviderStatus(providerModId).name());
	}

	public static boolean isProviderActive(String providerModId) {
		return MineralogyApi.isOreTakeoverActive(providerModId);
	}
