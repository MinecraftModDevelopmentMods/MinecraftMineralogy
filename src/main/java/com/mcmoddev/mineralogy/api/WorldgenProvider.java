...
/**
 * Immutable declarative world-generation contribution submitted to Mineralogy.
 * All registry objects are represented by IDs and resolved only when Mineralogy
...
public final class WorldgenProvider {
	...
	public static final class RockDefinition implements JsonDefinition {
		...
		public static Builder builder(ResourceLocation block, GeologyFamily family) {
			return new Builder(block, family);
		}
		...
		public static final class Builder {
			...
			private Builder(ResourceLocation block, GeologyFamily family) {
	...
	public static final class OreDefinition implements JsonDefinition {
		...
		public static Builder builder(ResourceLocation block) { return new Builder(block); }
		public ResourceLocation block() { return block; }
		public boolean enabled() { return enabled; }
		...
		public static final class Builder {
			...
			private Builder(ResourceLocation block) { this.block = Objects.requireNonNull(block, "block"); }
			public Builder enabled(boolean value) { enabled = value; return this; }
	...
	public static final class OreDimensionDefinition implements JsonDefinition {
		...
		public static final class Builder {
			...
			public Builder pattern(OrePattern value) { pattern = Objects.requireNonNull(value); return this; }
	...
	public static final class GeologyTemplate implements JsonDefinition {
		...
		public static final class Builder {
			...
			private Builder(ResourceLocation id) {
				...
				nameKey = "mineralogy.template." + id.getNamespace() + "." + id.getPath();
