...
public final class WorldgenBenchmark {
	...
	private static final String PROPERTY = "mineralogy.worldgenBenchmarkMode";
	...
	private static void onServerStarted(ServerStartedEvent event) {
		...
		int radius = boundedInteger("mineralogy.worldgenBenchmarkRadius", 4, 1, 16);
		int repetitions = boundedInteger("mineralogy.worldgenBenchmarkRepetitions", 3, 1, 9);
		int warmupRadius = Math.min(2, radius);
		int chunks = squareDiameter(radius);

		LOGGER.info("MINERALOGY_BENCHMARK start mode={} seed={} target_chunks={} repetitions={} "
		...
		for (int repetition = 0; repetition < repetitions; repetition++) {
			...
			LOGGER.info("MINERALOGY_BENCHMARK result mode={} repetition={} chunks={} elapsed_ms={} ms_per_chunk={}",
		...
		LOGGER.info("MINERALOGY_BENCHMARK summary mode={} chunks_per_repetition={} repetitions={} "
