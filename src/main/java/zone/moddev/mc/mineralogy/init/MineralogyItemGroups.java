...
public final class MineralogyItemGroups {
	...
	public static ItemGroup forBlock(Block block) {
		...
		switch (MineralogyConfig.creativeTabPolicy().groupFor(block.getClass())) {
			...
			default: return ItemGroups.ITEM;
		}
	}
	...
	public static ItemGroup forFertilizer() {
		return MineralogyConfig.groupCreativeTabItemsByType() ? ItemGroups.ITEM : ItemGroup.MATERIALS;
	}
