package zone.moddev.mc.mineralogy.lib.util;
...
import zone.moddev.mc.mineralogy.lib.interfaces.IMMDCreativeTab;
import zone.moddev.mc.mineralogy.lib.interfaces.IMMDMaterial;
import zone.moddev.mc.mineralogy.lib.interfaces.IMMDObject;
...
public class MMDCreativeTab extends CreativeTabs implements IMMDCreativeTab {
    ...
    /* (non-Javadoc)
     * @see zone.moddev.mc.mineralogy.lib.util.IMMDCreativeTab#hasSearchBar()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see zone.moddev.mc.mineralogy.lib.util.IMMDCreativeTab#displayAllRelevantItems(net.minecraft.util.NonNullList)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see zone.moddev.mc.mineralogy.lib.util.IMMDCreativeTab#createIcon()
     */
    @Override
    @SideOnly(Side.CLIENT)
    ...
    /* (non-Javadoc)
     * @see zone.moddev.mc.mineralogy.lib.util.IMMDCreativeTab#setSortingAlgorithm(java.util.Comparator)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see zone.moddev.mc.mineralogy.lib.util.IMMDCreativeTab#setTabIconItem(net.minecraft.block.Block)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see zone.moddev.mc.mineralogy.lib.util.IMMDCreativeTab#setTabIconItem(net.minecraft.item.Item)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see zone.moddev.mc.mineralogy.lib.util.IMMDCreativeTab#setTabIconItem(net.minecraft.item.ItemStack)
     */
    @Override
