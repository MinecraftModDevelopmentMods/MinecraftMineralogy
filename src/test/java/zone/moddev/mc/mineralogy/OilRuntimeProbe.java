...
public final class OilRuntimeProbe {
    ...
    public void serverStarted(FMLServerStartedEvent event) {
        ...
        try {
            ...
            world.getChunkFromBlockCoords(base);
            ...
            require(FluidContainerRegistry.containsFluid(filled,
                    FluidRegistry.getFluidStack(MineralogyFluids.FLUID_NAME, FluidContainerRegistry.BUCKET_VOLUME)),
                    "fluid-container registration");
            ...
            FillBucketEvent fill = new FillBucketEvent(player, new ItemStack(Items.BUCKET), world,
                    new RayTraceResult(new Vec3d(base).addVector(0.5D, 0.5D, 0.5D), EnumFacing.UP, base));
            ...
            LOGGER.info("MINERALOGY_OIL_RUNTIME_PROBE_PASS pickup=true placement=true flow=true container=true fluid={}",
                    MineralogyFluids.FLUID_NAME);
