...
public class DocumentationContractTest {
    ...
    @Test
    public void guidesDescribeTheTargetNative112Contract() throws Exception {
        String all = "";
        ...
        assertTrue(all.contains("Minecraft 1.12.2"));
        assertTrue(all.contains("Forge 14.23.5.2859"));
        assertTrue(all.contains("4.0.7.112021"));
        ...
        assertTrue(targetNativeGuides.contains("Java 8 toolchain"));
        assertTrue(targetNativeGuides.contains("Java 17-or-newer runtime"));
