...
public class FurnacePersistenceContractTest {
    ...
    public void reflectiveLoaderCanConstructAndRestoreFurnaceContents() throws Exception {
        TileEntityRockFurnace original = new TileEntityRockFurnace(1.2F);
    ...
    public void reflectiveLoadPathRecoversTheOwningRocksBurnModifier() {
        RockFurnace furnace = new RockFurnace(5.0F, 100.0F, 2, false, 1.2F);

        assertEquals(1.2F,
                TileEntityRockFurnace.burnModifierFor(furnace, 1.0F), 0.0F);
        assertEquals(1.0F,
                TileEntityRockFurnace.burnModifierFor(Blocks.FURNACE, 1.0F), 0.0F);
    }
